        ...
        <Tabs defaultValue="overview" className="space-y-4">
          ...
          <TabsContent value="projects" className="space-y-4">
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
              {[
                { title: "E-commerce Platform",  description: "Plataforma con Next.js",          status: "En progreso", progress: 65,  team: 5 },
                { title: "Mobile App",           description: "Aplicación con React Native",     status: "En revisión", progress: 90,  team: 3 },
                { title: "Dashboard Analytics",  description: "Panel con visualizaciones",       status: "Planificado", progress: 20,  team: 4 },
                { title: "API Gateway",          description: "Microservicios con Node.js",      status: "En progreso", progress: 45,  team: 6 },
                { title: "Design System",        description: "Librería de componentes",         status: "Completado",  progress: 100, team: 2 },
                { title: "Marketing Website",    description: "Sitio web institucional",         status: "En progreso", progress: 75,  team: 3 },
              ].map((project, i) => (
                <Card key={i}>
                  <CardHeader>
