      ...
      <div className="max-w-6xl mx-auto">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-blue-50 p-4 rounded-lg">
              <p className="text-sm text-blue-800">
                ...
                click, animación de loading, gradientes complejos, transiciones hover
              </p>
            </div>
          </div>
        </Card>
        ...
        >
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap gap-3">
              <Badge variant="success" size="sm" rounded>Small</Badge>
              <Badge variant="error" size="md" rounded>Medium</Badge>
              <Badge variant="warning" size="lg" rounded>Large</Badge>
            </div>
          ...
          <Card
            ...
            footer={
              <div className="flex justify-between items-center">
                <Badge variant="info" size="sm">Desarrollo</Badge>
        ...
        <Card title="Resumen de Técnicas Usadas" className="mb-8">
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <h4 className="font-bold text-lg mb-3 text-purple-600">CSS Modules</h4>
              <ul className="space-y-2 text-sm">
                {[
                  "Animaciones complejas (onda, shake, spin)",
                  "Pseudo-elementos (::before, ::after)",
                  "Gradientes avanzados con sombras",
                  "Keyframe animations personalizadas",
                  "Labels flotantes con transiciones",
                ].map((item) => (
            ...
            <div>
              <h4 className="font-bold text-lg mb-3 text-blue-600">Tailwind CSS</h4>
              <ul className="space-y-2 text-sm">
                {[
